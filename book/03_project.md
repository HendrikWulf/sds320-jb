...
SDS320 is organised around an independent spatial data science project. The project is the main structure through which you apply {abbr}`SDS (Spatial Data Science)` concepts, Python workflows, GeoAI methods, evaluation, documentation and communication.
...
1. [Project lifecycle](03_project/01_lifecycle.md) — understand the full process from first idea to final project.
2. [Milestones](03_project/02_milestones.md) — translate the semester schedule into project checkpoints.
3. [Research question](03_project/03_research-question.md) — turn a broad topic into a feasible spatial question.
4. [Workflow design](03_project/04_workflow-design.md) — plan the steps from raw data to interpretable results.
5. [Data, methods and scope](03_project/05_data-methods-scope.md) — check whether your question, data and method fit together.
6. [Reproducibility](03_project/06_reproducibility.md) — make your project understandable and rerunnable.
7. [Repository](03_project/07_repository.md) — organise the assessed public project repository.
...
- a public {term}`Repository` that another student can understand,
