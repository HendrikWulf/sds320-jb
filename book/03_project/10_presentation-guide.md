...
Explaining your project clearly at concept and final stage
</div>
...
Keep the presentation focused. At this stage, it is better to be clear about open questions than to pretend that everything is already solved.
...
This is a recommendation, not a rule. Adapt it to your project and time limit.

<!-- TODO: add final presentation duration and slide-number recommendation if provided. -->

UZH presentation templates are available from the Corporate Design website:

<https://www.cd.uzh.ch/en/templates.html#Presentations>

<!-- TODO: confirm whether use of the UZH slide template is required or only recommended for SDS320. -->
...
For more, see [Figures and maps](08_figures-and-maps.md).

```{tip}
One clear key-result slide is often more convincing than five crowded result slides.
```
...
Read it aloud. If it takes too long or feels unclear, simplify the project story.
