...
[https://hendrikwulf.github.io/sds320-jb/](https://hendrikwulf.github.io/sds320-jb/)
...
The MS Teams class is called **[26HS SDS320 - Spatial Data Analytics](https://teams.microsoft.com/l/team/19%3AIEn5eUvTvifBNhTYy5c6QHThZBnfhbXXf2Gf0P79n501%40thread.tacv2/conversations?groupId=80cc9d15-0b06-4e98-ace8-b733dc45aee1&tenantId=c7e438db-e462-4c22-a90a-c358b16980b3)**.
...
- [SDS210 GeoPython](https://hendrikwulf.github.io/sds210-jb/)
...
- [GitHub](https://docs.github.com/en) and [GitLab](https://docs.gitlab.com/) documentation
- See also: [Git basics](../02_setup/git-basics.md)
- See also: [Repository](../03_project/repository.md)
...
- [Xarray](https://docs.xarray.dev/en/stable/) / [Rioxarray](https://corteva.github.io/rioxarray/stable/) documentation
- [Leafmap](https://leafmap.org/) / [Folium](https://python-visualization.github.io/folium/latest/) documentation
...
- [TorchGeo documentation](https://torchgeo.org/)

### Related courses, materials and platforms

- [GeoAI](https://opengeoai.org/) by [Qiusheng Wu](https://gishub.org/)
- [GeoAI Tutorial Videos](https://youtube.com/playlist?list=PLAxJ4-o7ZoPcvENqwaPa_QwbbkZ5sctZE&si=2-6fs0qsZkkmKNVV)
- [Geospatial Python Tutorials](https://www.geopythontutorials.com/introduction.html) by [Spatial Thoughts](https://spatialthoughts.com/)
...
- [Project handbook](../03_project.md) — guidance from project idea to final report and presentation.
- [Assessment](assessment.md) — official overview of assessment components and expectations.
<!-- - [Project gallery](../05_gallery.md) — selected student projects from previous years. -->
- [Reference](../06_reference.md) — glossary, cheatsheets, common errors, datasets and further reading.
