...
For example, you may return to the [Project handbook](../03_project.md) when refining your research question, planning your workflow, improving your repository or preparing your report.

You may return to the [Reference](../06_reference.md) section when you need a quick reminder about terminology, common errors, model evaluation or datasets.
...
You can also use the [feedback page](../07_feedback.md) to report unclear explanations, broken links or code that does not work as expected.
